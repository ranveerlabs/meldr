...
const COMMANDS = {
  ...
  serve: {
    ...
    usage: 'meldr serve [--stateful] [--require-auth] [--from recording.json] [--port N] [--cors]',
    flags: { stateful: 'bool', 'require-auth': 'bool', from: 'string', port: 'int', host: 'string', cors: 'bool', contract: 'string', config: 'string' },
    run: cmdServe,
  },
  gen: {
